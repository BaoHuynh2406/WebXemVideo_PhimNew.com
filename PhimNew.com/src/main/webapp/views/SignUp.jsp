				...
				<div
					...
					<form name="frmdk" action="/SignUp" method="post">
						...
						<div class="form-outline mb-3">
							<div class="input-group">
								<span class="input-group-text" id="basic-addon1"> <i
									...
									ng-minlength="6" name="userName" placeholder="nguyenvannam123"
									class="form-control" />
							</div>
						...
						<div class="form-outline mb-3">
							<div class="input-group">
								<span class="input-group-text" id="basic-addon1"><i
									class="fas fa-lock"></i></span> <input required ng-minlength="6"
						...
						<div class="form-outline mt-4 mb-5">
							<div class="input-group">
								...
								</span> <input type="date" required name="date" class="form-control " />
							</div>
						...
						<!-- Submit button -->
						<button type="submit" formaction="./user/create" class="btn btn-primary btn-lg btn-block w-100 mb-4">
							Đăng ký
						</button>
