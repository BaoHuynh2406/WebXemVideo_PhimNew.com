    ...
    <div class="container  h-100">
        <div class="row d-flex align-items-center justify-content-center h-100">
            ...
            <div class="card px-5 py-4 col-sm-12 col-md-9 col-lg-7 col-xl-5 offset-xl-1">
                ...
                <form name="frmdk" action="/PhimNew/SignUp" method="post">
                    ...
                    <div class="form-outline mb-3">
                        <div class="input-group">
                            ...
                            <input type="text" name="id" placeholder="abc123" class="form-control" value="${user.id}" />
                        </div>
                    ...
                    <div class="form-outline mt-4 mb-5">
                        <div class="input-group">
                            ...
                            <input type="date" required name="" value="" class="form-control"  />
                        </div>
