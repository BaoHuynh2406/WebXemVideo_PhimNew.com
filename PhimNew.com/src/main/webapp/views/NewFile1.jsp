...
<body>
	...
	<form class="div_form" action="/Lab5java4spring2024/user/index" method="post">
		...
		<button formaction="/Lab5java4spring2024/user/create" class="btn btn-outline-success">Create</button>
		<button formaction="/Lab5java4spring2024/user/update" class="btn btn-outline-warning">Update</button>
		<button formaction="/Lab5java4spring2024/user/delete" class="btn btn-outline-danger">Delete</button>
		<button formaction="/Lab5java4spring2024/user/reset" class="btn btn-outline-info">Reset</button>
	</form>
	<table class="table">
		<thead>
			<tr>
		...
		<tbody>
			<c:forEach var="user" items="${users}">
				<tr>
					...
					<td><a href="/Lab5java4spring2024/user/edit/?id=${user.id}">
						edit
						</a>
						<a class="delete" href="/Lab5java4spring2024/user/delete/?id=${user.id}">
						delete
						</a>
					</td>
				</tr>
